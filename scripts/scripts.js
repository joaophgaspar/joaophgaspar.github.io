...
$(projects).each(function(i, item) {
    ...
    var row_element = '<div class="row">' +
        '<div class="col-sm-12">' +
        '<h2><a href="' + item.link + '" target="_blank" class="textinfo">' + item.name + '</a></h2>' +
...
// text TAB
msg = "Hi there, my name is João Gaspar. I’m a ¯\_(ツ)_/¯ Designer based in Lisbon, PT. ";
position = 0;
